  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-botones
      .titulo-principal__numero
        span.ch 2
      h1 Métodos de selección de propuesta
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-md-5
        figure
          img(src='@/assets/curso/temas/tema2/img2-1.svg', alt="Personas revisando notas en un tablero")

    .row.justify-content-center.mb-5
      .col-lg-10
        .cajon.color-acento-botones.cfct.p-4
          p.mb-0 En resumen, 
            b los métodos son herramientas que ayudan a clarificar mejor la propuesta del producto, 
            | además de las prestaciones que debe tener y lo más importante, a qué punto o público (clientes) está dirigido; teniendo presente la necesidad insatisfecha en ellos y que dicho producto apunta satisfacer.
    ...
    SlyderA.mb-5
      ...
      .row
        .col-md-6.mb-4.mb-md-0
          ...
          ol
            li.mb-3
              i.fas.fa-square.cab.me-3
              | Es difícil realizar esta técnica a gran escala.

            li.mb-3
              i.fas.fa-square.cab.me-3
              | Se obtienen resultados poco certeros al recibir retroalimentación que viene de manera subjetiva o poco sincera.

            li.mb-3
              i.fas.fa-square.cab.me-3
              | Hay posibilidad de perder el control del grupo en cuestión o que los participantes pierdan el interés sobre el tema del que se trata.

            li.mb-3
              i.fas.fa-square.cab.me-3
              | Se necesita un moderador que sea empático, para sacar así lo mejor de cada participante.
      ...
      .row
        ...
        .col-md-6
          figure
            img(src='@/assets/curso/temas/tema2/img2-7.png', alt='Joven usando pantalla interactiva')
    
    p Para aprender más acerca de la selección de propuesta y tener conocimientos más claros sobre el 
     b cliente 
     | y las 
     b necesidades del cliente, 
     | se recomienda observar los videos que se encuentran en el material complementario.
